...
sg1=`aws ec2 describe-security-groups --filters Name=tag:Name,Values=asg1 --query 'SecurityGroups[].GroupId' --region us-east-1 --output text`
sg2=`aws ec2 describe-security-groups --filters Name=tag:Name,Values=asg2 --query 'SecurityGroups[].GroupId' --region us-east-1 --output text`
